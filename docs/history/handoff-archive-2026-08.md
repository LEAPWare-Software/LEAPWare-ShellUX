# HANDOFF archive, to 2026-09-18

> Moved here verbatim from `HANDOFF.md` on 2026-09-18, when `HANDOFF.md` was cut to
> the 3000-byte cap the owner set on 2026-09-17. Nothing below was edited except relative links, corrected for this location. It is the
> record, not the current state: several of its counts and "in flight" entries were
> stale when it moved. Current state is `HANDOFF.md`.
...
**The decisions board is at [`docs/DECISIONS.md`](../DECISIONS.md): six open, and
...
[`docs/plans/native-host-pivot.md`](../plans/native-host-pivot.md).
...
- ~~**CI never audits the dev tree.**~~ **CLOSED 2026-09-18:** `npm run audit:all` now
  ...
  **Re-reproduced 2026-08-02 on a fresh `npm ci`: 6 vulnerabilities, 3 moderate / 1 high /
  ...
  package carrying the criticals. See [`docs/dependabot-triage.md`](../dependabot-triage.md).
...
[`docs/plans/native-host-pivot.md`](../plans/native-host-pivot.md) is the sequence now;
...
- **[`docs/adr/0003-quality-over-velocity.md`](../adr/0003-quality-over-velocity.md)**
