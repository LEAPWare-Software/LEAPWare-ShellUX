...
- [x] Contract items not covered by Step 6b ship as documented limits (D-35, now narrowed to exclude #16, #17, #28, #32, #57, #68 and #80). The one remaining, #91, is named in `DEVELOPER.md`'s "Known limits at 1.0". [C-34]
