 ...
 * cannot use.
 */
export const SHELL_ICONS: ReadonlyMap<string, ReactElement> = new Map<string, ReactElement>([
  ...
  [
    'settings',
    glyph(['M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z', 'M8 1.5v2', 'M8 12.5v2', 'M1.5 8h2', 'M12.5 8h2']),
  ],
...
export const FALLBACK_ICON: ReactElement = glyph(['M3.5 3.5h9v9h-9z']);
