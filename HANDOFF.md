...
`main` at `f0bf492` (#192, 2026-09-19). Mission: a best-in-class UI/UX shell hosting
...
- The proof audit — false claims corrected, checks tightened.
...
1. ADR-0006 steps 6 to 11, and W3-3 onward.
